 ...
 <div class="col-md-12 col-sm-12">
   ...
   <div class="col-md-12 col-sm-12">
     ...
     <ul class="nav nav-tabs">
       ...
       <li><a data-toggle="tab" href="#tabfile" id="navtabfile" data-val="<?= @$content->contentid; ?>">File/Images</a></li>
     ...
     <div class="tab-content">
       <div id="tabcontent" class="tab-pane fade in active">
         <ul style="list-style: none; padding: 0; margin: 0;">
           <?php $index = 0;
            foreach ($content_list as $contents): ?>
     ...
     if (cookieName &&
       ...
       if (localStorage.currentexercise) {
         if (localStorage.getItem('currentexercise') == 'Y') {
           ...
           if (typeof downloadTimer === 'undefined') {} else {
             clearInterval(downloadTimer);
           }
