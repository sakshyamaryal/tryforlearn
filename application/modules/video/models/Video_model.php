...
{
	public function savevideo ($data_arr)
	{
		$this->db->insert('video', $data_arr);
	...
	public function get_video ()
	{
		...
		$query = $this->db->query("select * from video where is_active=1 and $where order by $field $order limit $skip, $take");
		return $query->result();
	}
	...
	public function count_all_video ()
	{
		$this->db->select(" * ");
		$this->db->from('video');
	...
	public function updateImage ($videoId, $fileName)
	{
		$data = array(
