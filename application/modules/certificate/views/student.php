      ...
      <div class="modal-body">
          ...
          <div class="row">
              <div class="form-group col-md-6">
                <!--<label for="certificateType">Example select</label>-->
                <select class="form-control" id="certificateid">
                  <option value="-1">Please Select Certificate</option>
                  <?php foreach($certificate as $list):?>                  <option value="<?=$list->certificateid;?>"><?=$list->name;?></option>
