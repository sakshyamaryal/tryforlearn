...
<div id="content" class="col-lg-10 col-sm-10">
		...
		<div class="box col-md-12">
			<div class="box-inner">
				...
				<div class="box-content">
					...
					<form action="<?php echo base_url(); ?>pages/updatePage" id="updatePage" method="post" enctype="multipart/form-data">
						<input type="hidden" name="id" id="id" value="<?php echo  $page->page_id; ?>">
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="address">Name</label>
									<input type="text" name="pageName" id="pageName" class="form-control" value="<?php echo $page->page_name; ?>">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
	...
	<script>
		$(document).ready(function () {
			...
			editor.value("<?php echo $page->long_desc; ?>");
			var status_data = [{name: "inactive", value: "0"}, {name: "Active", value: "1"}];

			var fileName = "<?php echo $page->image; ?>"
			...
			$("#files").kendoUpload({
				multiple: false,
				async: {
					saveUrl: "<?php echo base_url(); ?>pages/uploadImage",
					removeUrl: "<?php echo base_url(); ?>pages/removeImage",
					showFileList: true,
				},
				showFileList: true,
				files: initialFiles,
				...
				upload: function (e) {
					e.data = {pageId: "<?php echo $page->page_id; ?>"};
				},
				remove: function (e) {
					e.data = {pageId: "<?php echo $page->page_id; ?>"}
				...
				complete: function (e) {
					toastr.success('image image has been changed', {timeOut: 5000});
				}
			});
			...
			$('#status').data("kendoDropDownList").value("<?php echo $page->is_active; ?>");
			...
			$("#updatePage").unbind('submit').bind('submit', function (e) {
				e.preventDefault();
				validateField();
				if ($(this).valid() == true) {
					var form = $(this);
