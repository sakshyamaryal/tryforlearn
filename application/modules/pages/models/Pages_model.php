...
{
	public function savePage ($data_arr)
	{
		$this->db->insert('page', $data_arr);
	...
	public function get_page ()
	{
		...
		$query = $this->db->query("select * from page where is_active=1 and $where order by $field $order limit $skip, $take");
		return $query->result();
	}
	...
	public function count_all_page ()
	{
		$this->db->select(" * ");
		$this->db->from('page');
		$query = $this->db->get();
	...
	public function updateImage ($pageId, $fileName)
	{
		$data = array(
