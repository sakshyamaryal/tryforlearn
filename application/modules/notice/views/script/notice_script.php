<script>
	...
	$(document).ready(function () {
		dataSource = new kendo.data.DataSource({
			transport: {
				read: "<?php echo base_url(); ?>notice/get_notice",
				update: {
					url: "<?php echo base_url(); ?>notice/update",
					complete: function (e) {

						toastr.success('Notice has been updated', {timeOut: 5000})
						$("#grid").data("kendoGrid").dataSource.read();
					}
				},
				create: {
					url: "<?php echo base_url(); ?>notice/add",
					complete: function (e) {
						toastr.success('Notice has been added', {timeOut: 5000})
						$("#grid").data("kendoGrid").dataSource.read();
					}
				},
				upload: {
				...
				destroy: {
					url: "<?php echo base_url(); ?>notice/delete",
					complete: function (e) {
						toastr.success('notice has been deleted', {timeOut: 5000})
						$("#grid").data("kendoGrid").dataSource.read();
					}
				},
