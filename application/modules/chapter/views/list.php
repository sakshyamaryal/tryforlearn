		...
		<div class="modal-dialog modal-lg" role="document">
				...
				<div class="modal-content">
					...
					<div class="modal-body"  id="addbody">
					 ...
					 <div class="row">
                     <input type="hidden" id="chapterid" name="chapterid" value="0" class="form-control"/> 

					  <div class="col-md-12">
					 <label>Chapter Name</label><br/>
                     <input type="text" name="chaptername" id="chaptername" value="" class="form-control"/> 
					 ...
					 <div class="row">
					  <div class="col-md-2">
					  <button type="button" class="btn btn-success" id="btnsubmit" onclick="submitchapter()">Submit</button>
					  </div>
					 </div>
...
<?php  $this->load->view('script/chapter_script.php'); ?>
