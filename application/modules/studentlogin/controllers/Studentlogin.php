          ...
          if($data != '0')
          {
              ...
              $this->load->helper('email');
               ...
               // $message=" Your OTP CODE is: ".$submitcode." .<br/><br/> If you haven't performed this process. Please Ignore the mail.";
                 ...
                 $message.='<h2>Your Registered Username:</h2>';
                 $message.='<h1>'.$data->username.'</h1><br/>';
                 $message.='<h2>Verification OTP</h2>';
                $message.="<h1>".$submitcode."</h1>";
                 $message.='<hr width="70%">';
                 $message.='<p margin-top="2rem"> Please use the above OTP to reset your password. If you have not performed this process. Please Ignore the mail.';
                 $message.='<hr width="70%">';
