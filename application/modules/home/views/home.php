<section class="home-slider owl-carousel">
      <?php foreach($banner as $banr) : ?>
        <div class="slider-item" style="background-image:url(<?= $banr['image']; ?>);">
            <!--<div class="overlay"></div>-->
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-8 text-center ftco-animate">
                        <h1 class="mb-4"><?= $banr['title']; ?> <span><?= $banr['description']; ?></span></h1>
                    </div>
                </div>
            </div>
        </div>
             ...
             <?php foreach($category as $cat) : ?>
                <div class="col-md-3 d-flex services align-self-stretch pb-4 px-4 ftco-animate bg-primary">
                    <div class="media block-6 d-block text-center">
                        <div class="icon d-flex justify-content-center align-items-center" style="margin-top: 0px!important;">
