...
class Studentregister extends CI_Controller {
        ...
        else
        {
          ...
          // var_dump($sent);exit();
           ...
           $this->session->set_flashdata('success',"Please Verify your Email.");
            ...
            $data['msg']='Please Verify your Email. Verification Link is sent to your Email Account.<br/>Did not get a Email? <a href="'.base_url().'studentregister/resendverification/'.$this->input->post('email').'">Resend Verfication Link</a>';
             $view=array(
              'header'=>'themes/frontend/header',
              'sidebar'=>false,
              'body'=>'success',
    ...
    // var_dump($sent);exit();
     ...
     $this->session->set_flashdata('success',"Please Verify your Email.");
      $this->session->set_userdata('stid',$submit);
      $data['msg']='As per your Request. We have resend verification link to your Email Account.<br/>Did not get a Email? <a href="'.base_url().'studentregister/resendverification/'.$email.'">Resend Verfication Link</a>';
       $view=array(
        'header'=>'themes/frontend/header',
        'sidebar'=>false,
        'body'=>'success',
