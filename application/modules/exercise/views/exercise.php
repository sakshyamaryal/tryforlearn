<style>
    .wrs_tickContainer{display:none!important;}
    </style>
<div id="content" class="col-lg-10 col-sm-10">
    ...
    <li>
        <?php if($this->session->userdata('qtype')=='N') { ?>
            <a href="<?= base_url(); ?>exercise?l=<?=$this->session->userdata('levelname');?>&t=N">Exercise</a>

             <?php } else { ?>
                <a href="<?= base_url(); ?>exercise?l=<?=$this->session->userdata('levelname');?>">Exercise</a>
...
<input type="hidden" id="id" name="id" value="<?=@$sm->eid;?>" />
 ...
 Is Timer?<sup style="color:red;">*</sup>
  ...
  <div class="col-md-2 ">
  <label>
 Timer In Second.<sup style="color:red;">*</sup>
  </label>
  <input type="number"  class="form-control" placeholder="" name="timer" id="timer" min="0" value="<?=(@$sm->timing!='') ? $sm->timing :'50';?>">

  </div>

  <div class="col-md-3 ">
  <label>
Copy English to Nepali text field
  </label>
  <select id="copyfield" name="copyfield" class="form-control">
...
//CKupdate();
 ...
 CKEDITOR.replace('question' ,{
							filebrowserUploadUrl: '<?=base_url();?>exercise/ck_upload',
