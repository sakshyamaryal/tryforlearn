...
{
	public function saveBanner ($data_arr)
	{
		$this->db->insert('banner', $data_arr);
	...
	public function get_banner ()
	{
		...
		$query = $this->db->query("select * from banner where is_active=1 and  $where order by $field $order limit $skip, $take");
		return $query->result();
	}
	...
	public function updateImage ($bannerId, $fileName)
	{
		$data = array(
