...
<a href="javascript:void(0)" data-toggle="modal" data-target="#coursemodal"><i class="fa fa-plus"></i> Subscribe Course</a>
<table class="table">
    <thead>
      <tr>
        <th>S.N.</th>
    ...
    <tbody>
    <?php $sn=0; foreach($course as $data): $sn++; ?>

      <tr>
      <td><?= $sn; ?></td>
        <td><b><?= $data['subject_name']; ?></b><small><br/>Class: <?= $data['classname']; ?><br/>Program: <?= $data['levelname']; ?></small></td>
        <td><?= $data['pdate']; ?></td>
        <td><?= $data['edate']; ?></td>
        <td><?php if($data['current_status']=='1'){?><div class="alert alert-success">Active</div> <?php }else{ ?><div class="alert alert-danger">Expired</div><?php } ?></td>
      </tr>
    <?php endforeach; ?>
</tbody>
</table>
  ...
  <div class="modal-dialog" role="document" style="max-width: 1080px!important;">
    <div class="modal-content" style="height:230px;    width: 850px;">
      ...
      <div class="row">
                        ...
                        <div class="form-group">
                        <select id="classid" name="classid" class="form-control" style="cursor:pointer;" onchange="getsubject()">
                      <option value='-1'>Please Select </option>
                      </select>	
                      ...
                      <label>Select Subject</label>
                            ...
                            <div class="form-group">
                            <select id="subjectid" name="subjectid" class="form-control" style="cursor:pointer;" onchange="getpackage()">
                            <option value='-1'>Please Select </option>
                            </select>	
