...
<head>
  <title><?=$title; ?></title>
  <link rel="icon" href="https://www.tryforlearn.com/assets/try.png"> 
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <!--  <span id="siteseal"><script async type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=vXCB7kTo38J5YbFY4ZgZ9kaPFhLXKaLRW0lgkqgUtiRGkXZG7C0pee9gzvmN"></script></span> -->
                      <h5 style="color: #fff;margin-top:0rem;    font-size: 22px;
    font-weight: 500;">Our Payment Partner</h5>
...
<div class="modal" tabindex="-1" role="dialog" id="ansmodal">
  ...
  <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.6.11/js/lightgallery-all.min.js"></script> -->
    ...
    <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/95c75768/cloudflare-static/rocket-loader.min.js" data-cf-settings="7bc5c9033436b1e8f8c4bf09-|49" defer=""></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.6.11/js/lightgallery-all.min.js"></script>
<script>
