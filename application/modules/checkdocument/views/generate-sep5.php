    ...
    <div class="container-box">
        ...
        <div class="row-box">
            ...
            <div class="certificate-title-before">
                <img src="<?php echo base_url(); ?>upload/background/printable.png" style="width:70%;">
            </div>
            </div>
            
        </div>
        <div class="row-box2">
            <p style="text-align:left;"><strong>Certificate No. : <?= @$value['Document_Number']; ?></strong></p>
            <p class="main-text">This is to Certify that <br> Mr./Mrs. <b><?= @$value['Name']; ?></b> <br>From <b><?= @$value['Organization']; ?></b> <br>has actively participated as a learner of <span class="course"> <strong>36 hour Math Lab with Zero Cost and Geogebra++</strong></span> Conducted By TFL team <br>on <strong>2077-04-31 to 2077-05-17. </strong> <br></p>
            ...
            <div class="footer-main">
                ...
                <div class="signee">
                    ...
                    <div class="detail">
                        ...
                        <span>Chairman, Mathematics & <br>Computer Science Education Committee, <br> FOE, TU</span>
                    </div>  
                </div>
                <div class="signee">
                    <div class="signature" style="top:-30%;">
